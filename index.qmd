...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tr>
    ...
    <td colspan="2">Gradient Descent and Polynomial Regression</td>
  ...
  <tr>
    ...
    <td colspan="2">Probability and Logistic Regression</td>
    <td><a href="notes/03_SupportVectorMachines.qmd">Notes</a></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>Week 5 (9/23 and 9/25)</td>
    <td colspan="2">Support Vector Machines and Constrained Optimization</td>
    <td><a href="notes/04_LogisticRegression.qmd">Notes</a></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>Week 6 (9/30 and 10/2)</td>
    <td colspan="2">Kernel Methods and Neural Networks</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    ...
    <td colspan="2">Decision Trees and Gradient Boosting</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2">Autoencoders and Variational Autoencoders</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    ...
    <td colspan="2">Principal Component Analysis and Semantic Embeddings</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2">PAC Learning and Active Learning</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    ...
    <td colspan="2">Active Learning and Interpretability</td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
